        ...
        <div class="row">
            <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="actioncat.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="name">Name Of Category</label>
                                        <input type="text" class="form-control" name="c_name" id="name" placeholder="Enter category Name" autocomplete="nope" required onkeyup="return Validstr2();"/>
                                    </div>
                   ...
                   <div class="form-group">           
                                        ...
                                        <input type="file" class="form-control" accept="image/gif, image/png, image/jpeg, image/jpg" name="photo"  id="image" required>
                                    </div>
                   <div class="form-group">           
