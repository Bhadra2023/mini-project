...
<section id="main-content">
	<section class="wrapper">
        ...
        <input type="submit" name="btnsubmit" value="Add New" class="btn btn-primary" style="margin-left:2%; background-color:#70c8fd; " />
...
$sql=mysqli_query($conn,"SELECT * FROM tbl_cat");
   ...
   while($display=mysqli_fetch_array($sql))
   {
	...
	echo "<td><a style='color:#090' href='cupdate.php?cid=".$display['cid']."'>Edit</a> </td>";
    echo "<td>";
    if($display['cstatus']==1){
        echo '<p><a href="catinactivate.php?id='.$display['cid'].'$cstatus=1">Disable</a></p>';
    }else{
        echo '<p><a href="catactivate.php?id='.$display['cid'].'$cstatus=0">Enable</a></p>';
    }
