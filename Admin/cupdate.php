...
{
	$cid=$_GET["cid"];
	$sql=mysqli_query($conn,"SELECT * FROM tbl_cat c  WHERE cid='$cid'");
                            ...
                            <div class="position-center">
                                <form role="form" action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" value="<?php echo $display['c_name'];?>" required  onkeyup="Validstr();">
...
if(isset($_POST["btnsubmit"]))
{
	...
	$sql=mysqli_query($conn,"UPDATE tbl_cat SET c_name='$name' WHERE cid='$cid'");
	if($sql)
	{
		echo "<script>alert('Category Details Updated Successfully!!');window.location='categoryview.php';</script>";
	}
}
?>
