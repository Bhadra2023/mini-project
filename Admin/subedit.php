...
if(isset($_GET["subcat_id"]))
{
	...
	$sql=mysqli_query($conn,"SELECT * FROM tbl_subcategory WHERE subcat_id='$subcat_id'");
                            ...
                            <div class="position-center">
                                <form role="form" action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" value="<?php echo $display['subcat_name'];?>" autocomplete="nope" required>
                                    </div>
                                    <div class="form-group">
...
if(isset($_POST["btnsubmit"]))
{
	...
	$sql=mysqli_query($conn,"UPDATE tbl_subcategory SET subcat_name='$name',cid='$cid' WHERE subcat_id='$subcat_id'");
	if($sql)
	{
		echo "<script>alert('Subcategory Details Updated Successfully!!');window.location='subcategoryview.php';</script>";
	}
}
?>
