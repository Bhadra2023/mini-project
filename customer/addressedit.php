...
if(isset($_GET["address_id"]))
{
	...
	$sql=mysqli_query($conn,"SELECT * FROM address  WHERE address_id='$address_id'");
...
<select   name="cust_id" id="category" onchange="showResult(this.value)" class="form-control m-bot15" required >
...
?>
                     ...
                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="des" id="des" value="<?php echo $display['city'];?>" autocomplete="nope" required onkeyup="Validstr5();">
                                    </div>
                ...
                if (!val.match(/^[a-zA-Z ]*$/)) 
                {
                 ...
                 return true;
                                      ...
                                      <div class="form-group">           
                                        ...
                                        <input type="text" class="form-control" name="pincode" id="pincode" autocomplete="nope" value="<?php echo $display['pincode'];?>" required onkeyup="validatePincode()";>
                                    </div>
                           ...
                           function validatePincode(){
                            ...
                            return true;
                                   ...
                                   <div class="row">
                                    ...
                                    <input type="number"  class="form-control" name="phone" id="phone" value="<?php echo $display['phone'];?>" required onkeyup="validatePhone()"; autocomplete="nope" required/>
                           ...
                           phoneError.innerHTML = '10 digits starting with 6 7 8 or 9';
                            ...
                            <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" name="house" id="house" value="<?php echo $display['housename'];?>" autocomplete="nope" required  onkeyup="Validstr2();">
                ...
                if (!val.match(/^[a-zA-Z ]*$/)) 
                {
                 ...
                 return true;
                            ...
                            <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control" name="road" id="road" value="<?php echo $display['roadname'];?>" autocomplete="nope" required onkeyup="Validstr3();">
...
if(isset($_POST["btnsubmit"]))
{
    ...
    $sql=mysqli_query($conn,"UPDATE address SET districtid='$districtid',city='$des',pincode='$pincode',phone='$phone',housename='$house',roadname='$road' WHERE address_id='$address_id'");
	if($sql)
	{
		
		$_SESSION['vstatus'] = "Updated Successfully";
  
        echo "<script>;window.location='addressview.php'</script>";
	}
}
?>
