...
while($display=mysqli_fetch_array($sql))
{
 ...
 echo "<td>".$display["sname"]."</td>";
  echo "<td>".$display["pincode"]."</td>";
echo "<td>".$display["phone"]."</td>";
echo "<td>".$display["housename"]."</td>";
echo "<td>".$display["roadname"]."</td>";

 // echo "<td><a style='color:#090' href='viewmoreproduct.php?pid=".$display['pid']."'>Viewmore</a> </td>";
 echo "<td><a style='color:#090' href='addressedit.php?address_id=".$display['address_id']."'>Edit</a> </td>";
 echo "<td><a style='color:#090' href='delete.php?address_id=".$display['address_id']."'>Delete</a> </td>";
