               ...
               <div class="carousel-item active">
                  <div class="container">
                     ...
                     <div class="fashion_section_2">
                        ...
                        <?php 
                              include("config.php");
                             // $n="SELECT * FROM tbl_cat";
                             // $n1 = mysqli_query($conn, $query);
                             
$cid=$_GET['cid'];
                              $query= "SELECT * FROM tbl_subcategory where cid=$cid and sstatus='0'";
                              $query_run = mysqli_query($conn, $query);
                              $check_tbl_subcategory = mysqli_num_rows($query_run) > 0;
                              
                              
                          if($check_tbl_subcategory)
                          {
                            ...
                            <div class="col-lg-4 col-sm-4">
                              ...
                              <div class="box_main"> 
                               ...
                               <h4 class="shirt_text"><?php echo $row['subcat_name'];?> </h4>
                               
                             
                                 <div class="btn_main">
                      
                                    <div class="seemore_bt"><a style='color:#090' href="custproduct_view.php?id=<?php echo $row['subcat_id']; ?>">see More</a></div>
                                 </div>
                              </div>
                             </div>
                              <!-- </div> 
